export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-[#46433f] text-white py-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            {about.map((aboutItem) => (
              <li
                key={aboutItem.id}
                className="cursor-pointer hover:translate-x-1 duration-300 hover:text-orange-500 space-x-1"
              >
                <a href={aboutItem.path} className="hover:underline">
                  {aboutItem.title}
                </a>
              </li>
            ))}
