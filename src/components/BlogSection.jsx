  ...
  const blogPosts = [
    {
      ...
      description: "An exploration of spiritual perspectives and religious teachings on the afterlife.",
      image: "/blog/blog2.avif"
    },
    {
      category: "Donation",
      title: "Charity To Education For Needy People",
      description: "Supporting educational initiatives for underprivileged communities through charitable programs.",
